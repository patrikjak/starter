...
>
    ...
    <div class="card w-4/5 mx-auto">
        <div class="data">
            <p class="font-primary strong">@lang('pjstarter::pages.metadata.meta_title')</p>
            <p>{{ $metadata->title }}</p>
        </div>

        <div class="data mt-3%">
            <p class="font-primary strong">@lang('pjstarter::pages.metadata.meta_description')</p>
        ...
        <div class="data mt-3%">
            <p class="font-primary strong">@lang('pjstarter::pages.metadata.meta_keywords')</p>
        ...
        <div class="data mt-3%">
            <p class="font-primary strong">@lang('pjstarter::pages.metadata.canonical_url')</p>
        ...
        <div class="data mt-3%">
            <p class="font-primary strong">@lang('pjstarter::pages.metadata.structured_data')</p>
        ...
        <div class="data mt-3%">
            <p class="font-primary strong">@lang('pjstarter::general.created_at')</p>
        ...
        <div class="data mt-3%">
            <p class="font-primary strong">@lang('pjstarter::general.updated_at')</p>
